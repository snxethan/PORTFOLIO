...
import { FaExternalLinkAlt, FaUser, FaCertificate, FaTools } from "react-icons/fa"
...
const SkillsPage = ({ onTabChange, activeTab }: SkillsPageProps) => {
  const tabs = [
  ...
  const activeId = activeTab ?? "skills"
