  ...
  return (
    <>
      {loading ? (
        ...
        <aside className={`w-full md:max-w-md lg:w-80 bg-[#222222] rounded-xl border border-[#333333] shadow-lg p-6 pt-8 sticky top-[5.5rem] z-10 mx-auto lg:mx-0 ${className}`}>
