                  ...
                  <TooltipWrapper key={label} label={tooltip}>
                    {label === "Email" ? (
                      <button
                        ...
                        aria-label={label}
                        className="text-gray-300 hover:text-red-600 text-3xl transition-all duration-200 ease-out hover:scale-125 active:scale-100 border border-gray-600 hover:border-red-600 rounded-lg p-2"
                      >
                        <Icon />
                      </button>
                    ) : (
