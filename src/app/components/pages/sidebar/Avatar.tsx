...
const getSeasonalAvatar = (): string => {
  ...
  if (month === 12 && day < 25) return "/images/avatar/avatar_christmas.png"
  if (month === 12 && day >= 25) return "/images/avatar/avatar_christmas2.gif"
  if (month === 10) return "/images/avatar/avatar_halloween.png"
  if (month === 8 && day === 11) return "/images/avatar/avatar_birthday.png"
  if (month === 7) return "/images/avatar/avatar_summer.png"
...
const Avatar = () => {
  ...
  if (!avatarSrc) {
    return <div className="w-full h-full rounded-full bg-[#333333] animate-pulse" />
  }
