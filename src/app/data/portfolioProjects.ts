...
export const manualProjects: Project[] = [
  {
    ...
    language: "TypeScript",
    topics: ["neumont", "game-development", "typescript", "react", "tailwind", "web", "game", "Computer Science"],
  ...
  },
  {
    ...
    language: "Java",
    topics: ["neumont", "java", "javafx", "cli", "game", "Computer Science"],
  ...
  },
  {
    ...
    language: "Java",
    topics: ["java", "android studio", "neumont", "Computer Science"],
  ...
  },
  {
    ...
    language: "Java",
    topics: ["neumont", "java", "cli", "game", "Computer Science"],
  ...
  },
  {
    ...
    language: "TypeScript",
    topics: ["react", "typescript", "tailwind", "neumont", "portfolio", "web", "Computer Science"],
  ...
  },
  {
    ...
    language: "C#",
    topics: ["c#", "existing-codebase", "software-design-and-architecture", "neumont", "desktop-pet", "Computer Science"],
